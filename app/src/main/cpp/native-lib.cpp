...
Java_com_merseyside_admin_player_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
extern "C" {
JNIEXPORT void JNICALL Java_com_merseyside_admin_player_Utilities_Settings_init(JNIEnv *env, jobject obj, jobject ctx);
JNIEXPORT jint JNICALL Java_com_merseyside_admin_player_Utilities_Settings_getSomeValue(JNIEnv *env, jobject obj);
};
